package com.julivalex.note.model;
...
public class ModelTask implements Item {
    ...
    //Инициализируется из диалогового окна
    public ModelTask() {
        this.status = -1;
        this.timeStamp = new Date().getTime();
    }

    //Инициализируется из базы
    ...
    /**
     * Метод возвращает идентификарор цвета в зависимости от состояния
     * @return
     */
